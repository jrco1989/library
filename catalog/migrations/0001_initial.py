# Generated by Django 3.0.2 on 2020-01-14 19:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text="enter the book's name", max_length=100)),
                ('summary', models.TextField(help_text='insert a short description', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('types', models.CharField(help_text='enter the genre of the book', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
